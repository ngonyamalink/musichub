<?php
echo '<div class="panel panel-default"><div class="panel-heading">Please select the music category.</div></div>';
?>
<?php echo form_open_multipart(base_url() . 'open/get_music_by_category', 'class="form-inline"',1); ?>
<?php
